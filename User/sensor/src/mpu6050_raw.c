...
void mpu6050GetRawData(int16_t *gx, int16_t *gy, int16_t *gz, int16_t *ax, int16_t *ay, int16_t *az)
{
    ...
    *gx = (int16_t)((int16_t)buffer[0] << 8 | buffer[1]);
    *gy = (int16_t)((int16_t)buffer[2] << 8 | buffer[3]);
    *gz = (int16_t)((int16_t)buffer[4] << 8 | buffer[5]);

    mpu6050ReadBuffer(MPU6050_DEV_ADDR, MPU6050_REG_ACCEL_XOUT_H, buffer, 6);
    *ax = (int16_t)((int16_t)buffer[0] << 8 | buffer[1]);
    *ay = (int16_t)((int16_t)buffer[2] << 8 | buffer[3]);
    *az = (int16_t)((int16_t)buffer[4] << 8 | buffer[5]);
}
...
void mpu6050ReadFilteredData(int16_t *gx, int16_t *gy, int16_t *gz, int16_t *ax, int16_t *ay, int16_t *az)
{
    ...
    smooth_buffer[0][cur_idx] = *gx;
    smooth_buffer[1][cur_idx] = *gy;
    smooth_buffer[2][cur_idx] = *gz;
